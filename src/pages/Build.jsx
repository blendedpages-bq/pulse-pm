const weeks = [
  ...
  { num: 6, status: 'active', dates: 'May 22 - May 28, 2026', title: 'Hybrid retrieval and reranking', desc: 'Implementing BM25 + TF-IDF hybrid retrieval with Reciprocal Rank Fusion reranking — the permanent fix for terminology mismatch cases that query normalization partially addressed. Each result will carry tfidf_score, bm25_score, and rrf_score for full auditability. Additional targets: section ID tagging fix for appendix pages returning N/A (chunk metadata gap from W2), removal of debug print blocks in generate.py, and S2 documentation checklist gap investigation. RRF_K=60 per original paper. Vector DB evaluation closed — will not be revisited.', outputs: ['BM25 + TF-IDF hybrid retriever', 'RRF reranking — rrf_score per chunk', 'Section ID fix — appendix pages', 'Debug print cleanup', 'Retrieval benchmark — hybrid vs TF-IDF standalone'], wip: true },
