const weeks = [
  ...
  { num: 11, status: 'active', dates: 'Jul 10 - Jul 16, 2026', title: 'Compliance validation layer — engagement gate and constraint flagging', desc: 'Wiring the engagement validation gate and downstream constraint flagging layer into the live pipeline — the most consequential build week of Phase 3. The engagement gate enforces the system\'s own critical design rule before any path recommendation is made. Constraint flagging populates the downstream_flags fields for the first time. Both components close gaps confirmed at 100% failure rate across all three evaluation scenarios in Week 9.', outputs: ['engagement_validator.py', 'constraint_flagger.py', 'Engagement gate wired into generate.py', 'downstream_flags fields populated', 'S1-S3 re-scored'], wip: true },
  { num: 12, status: 'planned', dates: 'Jul 17 - Jul 23, 2026', title: 'Retrieval precedence and audit logging', desc: 'Implementing retrieval precedence-awareness so higher-priority sources cannot be displaced by lower-priority chunks without a score threshold. Building immutable audit logging — a non-negotiable gate in the original Phase 3 design, writing before every output delivery. Closes the three longest-standing architectural gaps in the system alongside Week 11 work.' },
