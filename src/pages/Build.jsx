const weeks = [
  ...
  { num: 7, status: 'planned', dates: 'May 29 - Jun 4, 2026', title: 'Applied architecture research — CommunityLIVE 2026', desc: 'Attending CommunityLIVE 2026 to evaluate enterprise-grade content intelligence architecture against the patterns being built in this framework. Focus areas: agentic case management, GraphRAG and Knowledge Discovery, IDP document classification, context engineering, and AI governance in regulated environments. Research is not FHA-specific — findings apply across any corpus-driven, compliance-bound decision support use case.', outputs: ['CommunityLIVE 2026 — communitylive.com', 'Session materials and reference content', 'GraphRAG and Knowledge Discovery architecture notes', 'Context engineering and Enterprise Context Engine concepts', 'Agentic case management pattern reference', 'AI governance framework observations', 'Financial services peer connections']},
