const weeks = [
  ...
  { num: 8, status: 'active', dates: 'Jun 5 - Jun 11, 2026', title: 'Evaluation metrics and hallucination scoring', desc: 'Building a structured evaluation framework to score retrieval accuracy, answer completeness, citation fidelity, and hallucination risk across test scenarios. Evaluation is manual and source-grounded — no automated metrics until ground truth labels exist. Carry-forwards from W6 addressed in parallel: section ID tagging fix for appendix pages, debug print cleanup in generate.py, reason field logic on partial answers, and delinquency status signal gap in classification rules. Source field wiring (ui/cli/eval) added to output metadata.', outputs: ['Evaluation framework — accuracy, hallucination, confidence', 'Scoring sheet — manual eval', 'Source field wired into output metadata', 'Section ID fix — appendix pages', 'Debug print cleanup', 'ExperimentLog — EXP-W8 entries'], wip: true },
