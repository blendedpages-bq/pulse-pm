const weeks = [
  ...
  { num: 6, status: 'active', dates: 'May 22 - May 28, 2026', title: 'Hybrid retrieval and reranking', desc: 'Upgrading the retrieval layer from single-method to hybrid retrieval with fusion reranking — improving ranking quality while preserving full score auditability on every returned chunk. Each result carries individual method scores and a combined ranking score, maintaining the interpretability requirement for compliance-grade retrieval. Additional work: section ID metadata fix for appendix pages, debug cleanup, and continued retrieval gap investigation from Week 5.', 
    outputs: ['Hybrid retrieval pipeline', 'Per-chunk audit scores', 'Section ID metadata fix', 'Retrieval benchmark — hybrid vs standalone baseline'], wip: true },
