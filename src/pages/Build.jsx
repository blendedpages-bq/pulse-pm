const weeks = [
  ...
  { num: 13, status: 'planned', dates: 'Jul 24 - Jul 30, 2026', title: 'Human-in-the-loop and escalation logic', desc: 'Designing escalation paths and human review triggers for cases the system cannot resolve with sufficient confidence.' },
  { num: 14, status: 'planned', dates: 'Jul 31 - Aug 6, 2026', title: 'Training content and job aid generation', desc: 'Generating training materials and job aids derived from the system\'s policy knowledge base for servicer onboarding use.' },
  { num: 15, status: 'planned', dates: 'Aug 7 - Aug 13, 2026', title: 'Full copilot simulation and end-to-end flow', desc: 'Running a complete end-to-end simulation of the copilot across the full pipeline — intake through audit log.' },
  { num: 16, status: 'planned', dates: 'Aug 14 - Aug 20, 2026', title: 'Refactor, package, and portfolio delivery', desc: 'Final refactor, packaging, and delivery of the complete framework as a portfolio artifact.' }
]
